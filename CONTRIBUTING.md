...
issue](https://github.com/cisagov/publish-egress-ip-terraform/issues) in this
...
request](https://github.com/cisagov/publish-egress-ip-terraform/pulls), you
...
```console
cd publish-egress-ip-terraform
pyenv virtualenv <python_version_to_use> publish-egress-ip-terraform
pyenv local publish-egress-ip-terraform
